...
svm_model = joblib.load('/workspaces/Diplomado_IA/streamlit_sentiment/model/svm_model.pkl')
nb_model = joblib.load('/workspaces/Diplomado_IA/streamlit_sentiment/model/naive_bayes_model.pkl')
lr_model = joblib.load('/workspaces/Diplomado_IA/streamlit_sentiment/model/logistic_regression_model.pkl')
